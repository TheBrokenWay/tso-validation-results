"""
Lymphatic filariasis data adapter.
...
class LymphaticFilariasisAdapter:
    """Data adapter for Lymphatic filariasis research data."""

    def __init__(self):
        self.disease_id = "lymphatic_filariasis"
        self.disease_name = "Lymphatic filariasis"
