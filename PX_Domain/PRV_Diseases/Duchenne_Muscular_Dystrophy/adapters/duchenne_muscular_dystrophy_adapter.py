"""
Duchenne muscular dystrophy data adapter.
...
class DuchenneMuscularDystrophyAdapter:
    """Data adapter for Duchenne muscular dystrophy research data."""

    def __init__(self):
        self.disease_id = "duchenne_muscular_dystrophy"
        self.disease_name = "Duchenne muscular dystrophy"
