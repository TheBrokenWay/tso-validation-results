...
class PompeDiseaseAdapter:
    """Data adapter for Pompe disease research data."""

    def __init__(self):
        self.disease_id = "pompe_disease"
        self.disease_name = "Pompe disease"
