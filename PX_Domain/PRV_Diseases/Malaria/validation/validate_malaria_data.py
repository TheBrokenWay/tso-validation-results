...
class MalariaValidationError(Exception):
    pass


def validate_data(data: dict) -> bool:
    """Validate data against Malaria constraints.

    TODO: Implement disease-specific validation rules.
    """
    if not data:
        raise MalariaValidationError("Empty data")
    return True
...
def load_constraints() -> dict:
    ...
    constraint_path = os.path.join(config_dir, "malaria_constraints.json")
