...
class KrabbeDiseaseAdapter:
    """Data adapter for Krabbe disease research data."""

    def __init__(self):
        self.disease_id = "krabbe_disease"
        self.disease_name = "Krabbe disease"
