"""
Marburg virus disease data adapter.
...
class MarburgVirusDiseaseAdapter:
    """Data adapter for Marburg virus disease research data."""

    def __init__(self):
        self.disease_id = "marburg_virus_disease"
        self.disease_name = "Marburg virus disease"
