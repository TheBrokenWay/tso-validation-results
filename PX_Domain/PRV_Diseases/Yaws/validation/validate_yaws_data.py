...
class YawsValidationError(Exception):
    pass


def validate_data(data: dict) -> bool:
    """Validate data against Yaws constraints.

    TODO: Implement disease-specific validation rules.
    """
    if not data:
        raise YawsValidationError("Empty data")
    return True
...
def load_constraints() -> dict:
    ...
    constraint_path = os.path.join(config_dir, "yaws_constraints.json")
