...
class DengueValidationError(Exception):
    pass


def validate_data(data: dict) -> bool:
    """Validate data against Dengue constraints.

    TODO: Implement disease-specific validation rules.
    """
    if not data:
        raise DengueValidationError("Empty data")
    return True
...
def load_constraints() -> dict:
    ...
    constraint_path = os.path.join(config_dir, "dengue_constraints.json")
