...
class SmallpoxValidationError(Exception):
    pass


def validate_data(data: dict) -> bool:
    """Validate data against Smallpox constraints.

    TODO: Implement disease-specific validation rules.
    """
    if not data:
        raise SmallpoxValidationError("Empty data")
    return True
...
def load_constraints() -> dict:
    ...
    constraint_path = os.path.join(config_dir, "smallpox_constraints.json")
