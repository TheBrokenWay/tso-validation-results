...
class BattenDiseaseAdapter:
    """Data adapter for Batten disease research data."""

    def __init__(self):
        self.disease_id = "batten_disease"
        self.disease_name = "Batten disease"
