...
class ChagasDiseaseAdapter:
    """Data adapter for Chagas disease research data."""

    def __init__(self):
        self.disease_id = "chagas_disease"
        self.disease_name = "Chagas disease"
