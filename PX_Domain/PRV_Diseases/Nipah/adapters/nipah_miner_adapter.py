...
# --- PATH SETUP ---
# Canonical location: PX_Domain/PRV_Diseases/Nipah/adapters/nipah_miner_adapter.py
# __file__ → adapters → Nipah → PRV_Diseases → PX_Domain → foundation (repo root)
ADAPTER_DIR = os.path.dirname(os.path.abspath(__file__))
NIPAH_ROOT = os.path.dirname(ADAPTER_DIR)
ROOT_DIR = os.path.dirname(os.path.dirname(os.path.dirname(NIPAH_ROOT)))
...
from PX_Domain.PRV_Diseases.Nipah.validation.validate_raw_data import validate_file_content
