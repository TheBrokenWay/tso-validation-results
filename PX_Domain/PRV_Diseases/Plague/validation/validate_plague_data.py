...
class PlagueValidationError(Exception):
    pass


def validate_data(data: dict) -> bool:
    """Validate data against Plague constraints.

    TODO: Implement disease-specific validation rules.
    """
    if not data:
        raise PlagueValidationError("Empty data")
    return True
...
def load_constraints() -> dict:
    ...
    constraint_path = os.path.join(config_dir, "plague_constraints.json")
