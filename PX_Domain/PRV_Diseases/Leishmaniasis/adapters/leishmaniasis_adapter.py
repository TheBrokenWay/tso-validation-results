...
class LeishmaniasisAdapter:
    """Data adapter for Leishmaniasis research data."""

    def __init__(self):
        self.disease_id = "leishmaniasis"
        self.disease_name = "Leishmaniasis"
