...
class ZikaVirusDiseaseValidationError(Exception):
    pass


def validate_data(data: dict) -> bool:
    """Validate data against Zika virus disease constraints.

    TODO: Implement disease-specific validation rules.
    """
    if not data:
        raise ZikaVirusDiseaseValidationError("Empty data")
    return True
...
def load_constraints() -> dict:
    ...
    constraint_path = os.path.join(config_dir, "zika_virus_disease_constraints.json")
