"""
Zika virus disease data adapter.
...
class ZikaVirusDiseaseAdapter:
    """Data adapter for Zika virus disease research data."""

    def __init__(self):
        self.disease_id = "zika_virus_disease"
        self.disease_name = "Zika virus disease"
