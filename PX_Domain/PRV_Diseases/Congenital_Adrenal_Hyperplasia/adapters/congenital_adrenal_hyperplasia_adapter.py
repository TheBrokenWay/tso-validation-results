"""
Congenital adrenal hyperplasia data adapter.
...
class CongenitalAdrenalHyperplasiaAdapter:
    """Data adapter for Congenital adrenal hyperplasia research data."""

    def __init__(self):
        self.disease_id = "congenital_adrenal_hyperplasia"
        self.disease_name = "Congenital adrenal hyperplasia"
