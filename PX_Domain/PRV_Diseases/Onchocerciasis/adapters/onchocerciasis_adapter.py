...
class OnchocerciasisAdapter:
    """Data adapter for Onchocerciasis research data."""

    def __init__(self):
        self.disease_id = "onchocerciasis"
        self.disease_name = "Onchocerciasis"
