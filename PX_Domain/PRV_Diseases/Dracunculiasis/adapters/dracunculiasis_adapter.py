...
class DracunculiasisAdapter:
    """Data adapter for Dracunculiasis research data."""

    def __init__(self):
        self.disease_id = "dracunculiasis"
        self.disease_name = "Dracunculiasis"
